...
```
docker build -t ufaproufax/nginx-rtmp .
docker run -it -p 1935:1935 -p 8080:80 --rm ufaproufax/nginx-rtmp
```
...
* [HLS.js Player](https://hls-js.netlify.app/demo/?src=http://43.229.79.66:8080/live/ufaxtest1.m3u8)
